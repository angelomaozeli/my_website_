...
- ""
date: "2021-09-30"
description: LBS MFA student experiences # the title that will show up once someone gets to this page
draft: false
image: LBS2.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
I prefer looking forward instead of looking back. Therefore, I chose to step away from traditional assurance role and pursue further finance studies in LBS. The first month at LBS is particularly challenging but rewarding. The Data Analytics for Finance course really made me step out of my comfort zone and equipped me with the higher level of quantitative skills.

We collaborated and used R to analyse data and observe trends. Here is one of the analysis project we learned at LBS.
